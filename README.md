...
Статичний bilingual-сайт Антона Лиштви для подачі. Проєкт не має бекенду, працює як звичайний `HTML/CSS/JS` сайт і деплоїться через GitHub Pages.
...
3. Для повного резюме сайт сам збирає багатосторінковий PDF у стилі сайту і завантажує його напряму
4. Якщо браузер не може згенерувати файл напряму, є fallback на стандартний друк / `Save as PDF`
